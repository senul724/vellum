...
export const metadata: Metadata = {
  title: "Senuri & Kaveen | Sri Lankan Wedding Celebration",
  description: "Join us in celebrating the Poruwa Ceremony & Wedding of Senuri & Kaveen on December 18, 2026 at The Grand Ballroom, Galle Face Hotel, Colombo.",
};

export default function WeddingSLLayout({
  children,
}: {
