  ...
  return (
    <footer className="relative py-16 px-6 bg-[#2C3E35] text-[#FAF7F2] overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          &ldquo;May the blessings of the Triple Gem be upon you. Two lives intertwined into one eternal journey.&rdquo;
        </blockquote>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#FAF7F2]/60 font-light">
          <p>© 2026 Senuri &amp; Kaveen. All rights reserved.</p>
          <div className="flex items-center gap-1 text-[#D4AF37]">
            <Sparkles className="w-3.5 h-3.5" />
            <span>The Grand Ballroom • Galle Face Hotel, Colombo</span>
          </div>
        </div>
      </div>
    </footer>
