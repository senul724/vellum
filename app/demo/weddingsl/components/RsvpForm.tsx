      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-[#2C3E35]/70 max-w-md mx-auto font-light">
            Please reply by <span className="font-semibold text-[#2C3E35]">November 15, 2026</span> to help us prepare for your auspicious presence.
          </p>
            ...
            <AnimatePresence mode="wait">
              {!submitted ? (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        type="text"
                        required
                        placeholder="e.g. Rohana Wickramasinghe"
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        type="email"
                        required
                        placeholder="e.g. rohana@example.com"
                  ...
                  <div className="space-y-3">
                    <label className="text-xs font-semibold uppercase tracking-wider text-[#2C3E35] flex items-center gap-2">
                      ...
                      Will you be attending the Poruwa &amp; Wedding? *
                    </label>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <p className="text-[11px] opacity-80 mt-0.5">We will be there!</p>
                      </button>
                      ...
                      >
                        ...
                        <p className="text-[11px] opacity-80 mt-0.5">Sending warm blessings</p>
                      </button>
                    </div>
                  </div>

                  {/* Attendance Count & Dietary Restrictions Row */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {/* Attendance Count */}
                    {formData.attending === "attending" && (
                      <div className="space-y-2">
                    ...
                    <div className={`space-y-2 ${formData.attending !== "attending" ? "sm:col-span-2" : ""}`}>
                      ...
                      <div className="relative">
                        ...
                        >
                          <option value="traditional">Traditional Sri Lankan Feast (Yellow Rice &amp; Spiced Curries)</option>
                          <option value="vegetarian">Pure Vegetarian</option>
                          <option value="vegan">Vegan</option>
                          <option value="seafood">Ceylon Seafood Special (Negombo Lagoon Crab &amp; Prawns)</option>
                ...
                >
                  ...
                  >
                    {formData.attending === "attending"
                      ? "Bohoma Sthuthi! We Can't Wait to Celebrate with You!"
                      : "Warm Blessings & Sthuthi!"}
                  </h3>

                  <p className="text-sm sm:text-base text-[#2C3E35]/80 leading-relaxed font-light max-w-md mx-auto mb-6">
                    {formData.attending === "attending"
                      ? `Your RSVP has been successfully confirmed for ${formData.fullName}. We look forward to welcoming your family to Galle Face Hotel on December 18, 2026!`
                      : `We will deeply miss your presence, ${formData.fullName}. Thank you so much for your heartfelt blessings and warm wishes.`}
                  </p>
